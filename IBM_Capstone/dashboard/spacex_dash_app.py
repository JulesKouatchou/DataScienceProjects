...
def get_scatter_chart(site_val, payload_val):
    low, high = payload_val
    filtered_df = spacex_df
    ...
    if site_val == 'ALL':
        ...
        filtered_df = filtered_df[filtered_df['Launch Site']==site_val]
        fig = px.scatter(filtered_df, 
            x="Payload Mass (kg)", 
            y="class",
            color="Booster Version Category")
